...
AstroHousePos::AstroHousePos(ChartBaseParams* cbp, ObjsVector* ov) : GraphicChartBase(cbp, ov, cbp->Ag)
{
    Ct = House_Pos;
    Cm = GraphicMode;
    DualChart = false;
    ...
    //CurAr->RestrictAll();
    CurAr->RestHouses(true);
    //CurAr-> RestStars(true);
